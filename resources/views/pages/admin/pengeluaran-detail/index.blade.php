              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <h3>INVOICE <b>{{ $codePengeluaran }}</b></h3>
                  </div>
                  <div class="col-6">
                    <h1>Total (Rp)</h1>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <input type="hidden" class="form-control" name="id_pengeluaran" value="{{ $id_pengeluaran }}" readonly>
            ...
            <form action="{{ route('pengeluaran.store') }}" class="form-pengeluaran" method="post">
              ...
              <div class="card">
                <div class="card-body">
                  {{-- Total Pengeluaran --}}
                  <div class="form-group row">
                    <label for="totalrp" class="col-lg-2 control-label">User</label>
                    <div class="col-lg-10">
