<div class="modal fade" id="modal-piutang" tabindex="-1" role="dialog" aria-labelledby="modal-piutang">
            ...
            <div class="modal-body">              
              <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                  <table class="table table-striped table-bordered table-detail-piutang">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      @foreach ($list_piutang_today as $item)
                        <tr>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th>Rp{{ format_uang($total_piutang_today ) }}</th>
                      </tr>
                    </tfoot>
                  </table>
                </div>
