...
<body>
    <table width="100%">
        <tr>
            ...
            <td>Tanggal</td>
            <td>: {{ tanggal_indonesia($pengeluaran->tgl_pengeluaran) }}</td>
        </tr>
        <tr>
            <td>Kode Pengeluaran</td>
            <td>: {{ $pengeluaran->code ?? 'Umum' }}</td>
        </tr>
    </table>

    <h3 class="text-center">BUKTI PENGELUARAN</h3>
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><b>Rp{{ format_uang($pengeluaran->total_harga) }}</b></td>
            </tr>
            @if (($pengeluaran->diskon) > 0)
                <tr>
                    <td colspan="6" class="text-right"><b>Diskon</b></td>
                    <td class="text-right"><b>{{ format_uang($pengeluaran->diskon) }}%</b></td>
                </tr>                              
            @endif
            <tr>
                <td colspan="6" class="text-right"><b>Total Bayar</b></td>
                <td class="text-right"><b>Rp{{ format_uang($pengeluaran->bayar) }}</b></td>
            </tr>
        </tfoot>
    </table> <br><br>
