          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Edit Countdown</h3>
              </div>
              <!-- /.card-header -->
              <form action="{{ route('countdown-update', $item->id) }}" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="form-group">
                        <label>Date and time:</label>
                          <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="text" name="date" class="form-control datetimepicker-input" data-target="#reservationdatetime" value="{{ $item->date }}" required/>
                ...
                <div class="card-footer text-right">
                  ...
                  <a href="{{ route('dashboard-admin') }}" class="btn btn-block btn-default">Kembali</a>
                </div>
              </form>
