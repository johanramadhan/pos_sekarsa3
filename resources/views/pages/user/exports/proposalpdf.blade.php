...
<body>
  ...
  <div class="position-relative">
    <h5 class="text-center cover text-uppercase">RENCANA KEBUTUHAN BARANG MILIK DAERAH (RKBMD) OLEH BIDANG  {{ $judul->user->bidang }}<br> DINAS PEMADAM KEBAKARAN DAN PENYELAMATAN KOTA PEKANBARU <br> TAHUN ANGGARAN 2021</h5>
  </div>

  <div class="page-break"></div>

  <h6 class="text-center text-uppercase" style="font-size: 14px;">RENCANA KEBUTUHAN BARANG MILIK DAERAH (RKBMD) OLEH BIDANG {{ $judul->user->bidang }} <br> PADA DINAS PEMADAM KEBAKARAN DAN PENYELAMATAN KOTA PEKANBARU <br> TAHUN ANGGARAN 2021</h6>
