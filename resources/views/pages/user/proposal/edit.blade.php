            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('pengajuans.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-footer text-right">
                  ...
                  <a href="{{ route('pengajuans.index') }}" class="btn btn-block btn-default">Kembali</a>
                </div>
              </form>
              <div class=" card-body mt-2">
                  ...
                  @foreach ($item->galleries as $gallery)
                    <div class="col-md-12 col-lg-6 col-xl-4">
                      <div class="small-box bg-dark mb-2">
                        ...
                        <a
                          href="{{ route('proposal-gallery-delete', $gallery->id) }}" class="small-box-footer">Delete <i class="fas fa-times"></i></a>
                      </div>
                    </div>
                  @endforeach
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <form action="{{ route('proposal-gallery-upload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
