              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="number" name="diskon" id="diskon" class="form-control" value="{{ ! empty($memberSelected->id_member) ? $diskon2 : 0  }}">
                    </div>
                  </div>
                  {{-- Bayar --}}
                  <div class="form-group row">
  ...
  <script>
    ...
    $(function () {
      ...
      $(document).on('input', '.quantity', function () {
            ...
            $.post(`{{ url('/kasir/data-transaction/transaction-detail') }}/${id}`, {
